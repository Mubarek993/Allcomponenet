import log from '../my-app/src/assets/images/icons/logo-sm.png'
import searchIcon from "../my-app/src/assets/images/icons/search-icon-sm.png";
import cart from "../my-app/src/assets/images/icons/cart-sm.png";
    ...
    <div className="nav-wrapper fixed-top">
		<div className="container">
			<nav className="navbar navbar-toggleable-sm navbar-expand-md">
			    ...
			    <a className="navbar-brand mx-auto" href="#"><img src={log}/></a>
